...
def write_flags(flag_fn, fasta_fn, xml_fn, silent_fn):
    ...
    flag_file.write("-relax:jump_move true\n")
    flag_file.write("-score:weights stage3_rlx.wts\n")
...
def write_stage1_wts(wts_fn):
    wts_file = open(wts_fn,'w')
    wts_file.write("# stage1 weights for hybridization\n")
    wts_file.write("env     1.0\n")
    wts_file.write("pair    1.0\n")
    wts_file.write("cbeta   1.0\n")
    wts_file.write("cenpack 1.0\n")
    wts_file.write("hs_pair 2.0\n")
    wts_file.write("ss_pair 2.0\n")
    wts_file.write("rsigma  2.0\n")
    wts_file.write("sheet   2.0\n")
    wts_file.write("vdw     0.2\n")
    wts_file.write("rg      2.0\n")
    wts_file.write("rama    0.3\n")
    wts_file.write("linear_chainbreak    2.0\n")
    wts_file.write("atom_pair_constraint 1.0\n")
    wts_file.close()

def write_stage2_wts(wts_fn):
    wts_file = open(wts_fn,'w')
    wts_file.write("# stage2 weights for hybridization\n")
    wts_file.write("hbond_sr_bb 2.0\n")
    wts_file.write("hbond_lr_bb 2.0\n")
    wts_file.write("rama        0.2\n")
    wts_file.write("omega       0.2\n")
    wts_file.write("rg          2.0\n")
    wts_file.write("vdw         1.0\n")
    wts_file.write("cen_env_smooth  2.0\n")
    wts_file.write("cen_pair_smooth 1.0\n")
    wts_file.write("cbeta_smooth    1.0\n")
    wts_file.write("cenpack_smooth  1.0\n")
    wts_file.write("cart_bonded     0.05\n")
    wts_file.write("atom_pair_constraint 0.5\n")
    wts_file.close()

def write_stage3_wts(wts_fn):
    wts_file = open(wts_fn,'w')
    wts_file.write("# stage3 fullatom weights for hybridization\n")
    wts_file.write("METHOD_WEIGHTS ref  0.16 1.7 -0.67 -0.81 0.63 -0.17 0.56 0.24 -0.65 -0.1 -0.34 -0.89 0.02 -0.97 -0.98 -0.37 -0.27 0.29 0.91 0.51\n")
    wts_file.write("fa_atr  0.8\n")
    wts_file.write("fa_rep  0.44\n")
    wts_file.write("fa_sol  0.65\n")
    wts_file.write("fa_intra_rep 0.004\n")
    wts_file.write("fa_pair 0.49\n")
    wts_file.write("fa_plane 0\n")
    wts_file.write("fa_dun  0.56\n")
    wts_file.write("ref     1\n")
    wts_file.write("hbond_lr_bb 1.17\n")
    wts_file.write("hbond_sr_bb 0.585\n")
    wts_file.write("hbond_bb_sc 1.17\n")
    wts_file.write("hbond_sc    1.1\n")
    wts_file.write("p_aa_pp     0.32\n")
    wts_file.write("dslf_ss_dst 0.5\n")
    wts_file.write("dslf_cs_ang 2\n")
    wts_file.write("dslf_ss_dih 5\n")
    wts_file.write("dslf_ca_dih 5\n")
    wts_file.write("pro_close   1.0\n")
    wts_file.write("rama    0.2\n")
    wts_file.write("omega   0.5\n")
    wts_file.write("atom_pair_constraint    0.5\n")
    wts_file.write("coordinate_constraint   0.0\n")
    wts_file.write("cart_bonded     0.5\n")
    wts_file.close()
