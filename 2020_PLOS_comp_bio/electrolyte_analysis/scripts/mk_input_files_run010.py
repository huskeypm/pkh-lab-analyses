...
Variables that must be set in the model template file (.yaml):
  ...
  - central_pore_potential: electric potential value on the pore
...
model_vars=odict([
  ...
  ('bot_flux_B', ['null']),
  ('bot_flux_C', ['null']),
  ('pore_flux_A', [[0.0,0.0,0.0]]),
  ('pore_flux_B', [[0.0,0.0,0.0]]),
  ('pore_flux_C', [[0.0,0.0,0.0]]),
  ('top_potential', [0.0]),
  ('bot_potential', [0.0]),
  ...
  ('nr_inc_conc_B', ['null']),
  ('nr_inc_conc_C', ['null']),
  ('nr_inc_flux_A', [[0.0,0.0,0.0]]),
  ('nr_inc_flux_B', [[0.0,0.0,0.0]]),
  ('nr_inc_flux_C', [[0.0,0.0,0.0]]),
  ('nr_inc_potential', [0]),
  ('kappa', [1.0])]
)
...
model_direct_fields=['basename','meshname','modelname',
                    ...
                    'top_flux_A','top_flux_B','top_flux_C',
                    'bot_flux_A','bot_flux_B','bot_flux_C',
                    'pore_flux_A','pore_flux_B','pore_flux_C',
