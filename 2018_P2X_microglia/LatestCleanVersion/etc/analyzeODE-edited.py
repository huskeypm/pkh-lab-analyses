...
def ProcessDataArray(dataSub,mode,timeRange=[0,1e3],key=None):
	  ...
	  tptxf = np.array([0,0.75,6,
			    11.25,18.75,30.75,
			    75])*10**-3
          Iptxf = np.array([0,-2.34,-0.73,
			   -0.30,-0.14,-0.084,
			   -0.0169])
	  ...
	  tptxs == np.array([0,6.4,30.7,
			     53.1,95.3,119.5,
	  		     123.7,127.8])*10**-3
          Iptxs == np.array([0,-0.006,-0.013,
			    -0.014,-0.013,-0.012,
			    -0.00083,-0.00012])
	  ...
	  tptxs == np.array([0,1.8,11.5,
			     16.5,67.8,119.1,
			     122.7,127.8])*10**-3
          Iptxs == np.array([0,-0.039,-0.051,
			    -0.051,-0.045,-0.041,
			    -0.0023,-0.0013])
	  modelptxs = [timeSeries, valueTimeSeries]
          litptxs = [tptxs, Iptxs]
	  ...
	  tptxs == np.array([0,0,7.33,25.65,
			     32.98,53.59,79.2,
                             94.81,107.18,118.6,
                             120.9,122.29])*10**-3
 	  Iptxs == np.array([0,-0.051,-0.068,
                            -0.080,-0.095,-0.21,
                            -0.59,-0.84,-0.90,
                            -0.033,-0.0030])
	  modelptxs = [timeSeries, valueTimeSeries]
